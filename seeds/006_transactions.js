  ...
  return knex('transactions').del()
    .then(function () {
      ...
      return knex('transactions').insert([
        ...
        {id: 4, recipient_id: 2, user_sender_id: 4, favor: 'house sitting', beer_id:  'Crooked Stave Raspberry Sour'},
        ...
        {id: 10, recipient_id: 6, user_sender_id: 4, favor: 'pet sitting',  beer_id: 'Old Rasputin' },
